...
public partial class PM : System.Web.UI.Page
{
    ...
    {
        System.IO.StreamReader file = new System.IO.StreamReader(Server.MapPath("~/PM/PM.txt"));
    ...
    {
        System.IO.StreamWriter file1 = new System.IO.StreamWriter(Server.MapPath("~/PM/PM.txt"), false);
        file1.Write(txttext.Text);
        file1.Close();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string filename = Server.MapPath("~/PM/PM.txt");
        Response.AppendHeader("Content-Disposition", "attachment; filename=" + filename);
        Response.WriteFile(Server.MapPath("~/PM/PM.txt"));
        Response.Flush();
        System.IO.File.Delete(Server.MapPath("~/PM/PM.txt"));
        Response.End();
        Response.Redirect("PM.aspx");
    }
