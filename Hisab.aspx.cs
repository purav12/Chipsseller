...
public partial class Hisab : System.Web.UI.Page
{
    User c = new User();
    DataTable dt;
    int totalremaining;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            dt = c.Getdata("select * from Static Where P=1 order by CAST(Data as int) Desc");
            ...
            lblid11.Text = dt.Rows[10]["Title"].ToString();
            lblstock11.Text = dt.Rows[10]["Data"].ToString();

            lbltotalstock9.Text = Convert.ToString(Convert.ToInt32(dt.Rows[0]["Data"].ToString()) + Convert.ToInt32(dt.Rows[1]["Data"].ToString()) + Convert.ToInt32(dt.Rows[2]["Data"].ToString()) + Convert.ToInt32(dt.Rows[3]["Data"].ToString()) + Convert.ToInt32(dt.Rows[4]["Data"].ToString()) + Convert.ToInt32(dt.Rows[5]["Data"].ToString()) + Convert.ToInt32(dt.Rows[6]["Data"].ToString()) + Convert.ToInt32(dt.Rows[7]["Data"].ToString()) + Convert.ToInt32(dt.Rows[8]["Data"].ToString()) +  Convert.ToInt32(dt.Rows[9]["Data"].ToString()) +  Convert.ToInt32(dt.Rows[10]["Data"].ToString()));
            
            //lblid10.Text = dt.Rows[99]["Title"].ToString();
            //lblstock10.Text = dt.Rows[99]["Data"].ToString();
        }
        getdetails("SELECT *,Case when Amount='0' then '9' else CONVERT(FLOAT,Amount)/Cast(Stock as int) end  AS Rate FROM DailyDetails ");
    ...
    {
        dt = c.Getdata("update Static set Data='" + lblstock1.Text + "' where Title='" + lblid1.Text + "'  and P=1  ");
        dt = c.Getdata("update Static set Data='" + lblstock2.Text + "' where Title='" + lblid2.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock3.Text + "' where Title='" + lblid3.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock4.Text + "' where Title='" + lblid4.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock5.Text + "' where Title='" + lblid5.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock6.Text + "' where Title='" + lblid6.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock7.Text + "' where Title='" + lblid7.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock8.Text + "' where Title='" + lblid8.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock9.Text + "' where Title='" + lblid9.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock10.Text + "' where Title='" + lblid10.Text + "'  and P=1 ");
        dt = c.Getdata("update Static set Data='" + lblstock11.Text + "' where Title='" + lblid11.Text + "'  and P=1 ");
        string names = "" + lblid1.Text + "-" + lblid2.Text + "-" + lblid3.Text + "-" + lblid4.Text + "-" + lblid5.Text + "-" + lblid6.Text + "-" + lblid7.Text + "-" + lblid8.Text + "-" + lblid9.Text + "-" + lblid10.Text + "-" + lblid11.Text + "-Final";
        string stocks = "" + lblstock1.Text + "-" + lblstock2.Text + "-" + lblstock3.Text + "-" + lblstock4.Text + "-" + lblstock5.Text + "-" + lblstock6.Text + "-" + lblstock7.Text + "-" + lblstock8.Text + "-" + lblstock9.Text + "-" + lblstock10.Text + "-" + lblstock11.Text + "-" + txtdiffrence.Text + "";
        dt = c.Getdata("insert into HisabBackup (Name,Stock) values ('" + names + "','" + stocks + "')");
        Response.Redirect("Hisab.aspx");
