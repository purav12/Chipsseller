<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="HisabTp.aspx.cs" Inherits="HisabTp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function GetDone() {
            ...
            var result = parseInt(lblstock1) + parseInt(lblstock2) + parseInt(lblstock3) + parseInt(lblstock4) + parseInt(lblstock5) + parseInt(lblstock6) + parseInt(lblstock7) + parseInt(lblstock8) + parseInt(lblstock9) + parseInt(lblstock10);
            if (!isNaN(result)) {
        ...
        <div id="container">
            ...
            <div id="contact" class="clear">
                <div class="one_half first">
                    <asp:HyperLink ID="HyperLink1" href="http://chipsseller.com/AdminUserTp.aspx" runat="server">Back</asp:HyperLink>
                    <br />
                    <br />
                    <br />
                    <div id="respond">
                        <h2>Hisab TeenPatti </h2>
                                    ...
                                    <table style="border: 5px solid; width: 400px;">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span style="float: right; padding-top: 0px; margin-bottom: 0px; margin-top: -25px; margin-right: 143px;">Lakhs</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                    ...
                                    <table style="border: 5px solid; margin-top: 100px; width: 100%; margin-left: 175px;">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span style="float: right; padding-top: 0px; margin-bottom: 0px; margin-top: -25px;">Lakhs</span>
                                            </td>
                                        </tr>
                                    </table>
                                    </br> </br>
