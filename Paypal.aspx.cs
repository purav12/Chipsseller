...
public partial class Paypal : System.Web.UI.Page
{
    ...
    protected void btn25m_Click(object sender, EventArgs e)
    {
        ...
        //redirectUrl += "&item_name=" + lblname1.Text + " Million &item_number=1&amount=" + lblcount1.Text + "";
        //redirectUrl += "&currency_code=INR&button_subtype=services&tax_rate=0&shipping=0&bn=PP%2dBuyNowBF%3abtn_paynow_LG%2egif%3aNonHosted";

        //Response.Redirect(redirectUrl);
        payumoney(lblcount1.Text, txtMailpaypal.Text, lblname1.Text);
    }
    protected void btn50m_Click(object sender, EventArgs e)
    {
        ...
        //string redirectUrl = "";
        //redirectUrl += "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=puravmehta01@yahoo.com&lc=IN";
        //redirectUrl += "&item_name=" + lblname2.Text + " Million &item_number=1&amount=" + lblcount2.Text + "";
        //redirectUrl += "&currency_code=INR&button_subtype=services&tax_rate=0&shipping=0&bn=PP%2dBuyNowBF%3abtn_paynow_LG%2egif%3aNonHosted";

        //Response.Redirect(redirectUrl);
        payumoney(lblcount2.Text, txtMailpaypal.Text, lblname2.Text);
    }
    protected void btn100m_Click(object sender, EventArgs e)
    {
        ...
        //string redirectUrl = "";
        //redirectUrl += "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=puravmehta01@yahoo.com&lc=IN";
        //redirectUrl += "&item_name=" + lblname3.Text + " Million &item_number=1&amount=" + lblcount3.Text + "";
        //redirectUrl += "&currency_code=INR&button_subtype=services&tax_rate=0&shipping=0&bn=PP%2dBuyNowBF%3abtn_paynow_LG%2egif%3aNonHosted";

        //Response.Redirect(redirectUrl);
        payumoney(lblcount3.Text, txtMailpaypal.Text, lblname3.Text);
    }
    protected void btn500m_Click(object sender, EventArgs e)
    {
        SetOrder(lblname4.Text, lblcount4.Text, txtMailpaypal.Text);
        //string redirectUrl = "";
        //redirectUrl += "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=puravmehta01@yahoo.com&lc=IN";
        //redirectUrl += "&item_name=" + lblname4.Text + " Million &item_number=1&amount=" + lblcount4.Text + "";
        //redirectUrl += "&currency_code=INR&button_subtype=services&tax_rate=0&shipping=0&bn=PP%2dBuyNowBF%3abtn_paynow_LG%2egif%3aNonHosted";

        //Response.Redirect(redirectUrl);
        payumoney(lblcount4.Text, txtMailpaypal.Text, lblname4.Text);
    }
    protected void btn1bill_Click(object sender, EventArgs e)
    {
        SetOrder(lblname5.Text, lblcount5.Text, txtMailpaypal.Text);
        //string redirectUrl = "";
        //redirectUrl += "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=puravmehta01@yahoo.com&lc=IN";
        //redirectUrl += "&item_name=" + lblname5.Text + " Billion &item_number=1&amount=" + lblcount5.Text + "";
        //redirectUrl += "&currency_code=INR&button_subtype=services&tax_rate=0&shipping=0&bn=PP%2dBuyNowBF%3abtn_paynow_LG%2egif%3aNonHosted";

        //Response.Redirect(redirectUrl);
        payumoney(lblcount5.Text, txtMailpaypal.Text, lblname5.Text);
    }
