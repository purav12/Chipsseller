...
public partial class Chart : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        Label9.Text = Totalremain.ToString();
        grdDaily.DataBind();
    }
    ...
    public void FillChart()
    {
        ...
        {            
            ...
            dsPieChart = c.GetDs("select SUM(Amount) AS Total,Proft_Loss from DailyDetails GROUP BY Proft_Loss");
