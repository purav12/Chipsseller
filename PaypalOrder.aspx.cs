...
public partial class PaypalOrder : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["USER"] != null)
        {
            ...
            {
                dt = ph.Getdata("SELECT  * FROM Paypal Order by Id Desc");
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        ...
        //ph.UPDATEPHISHING();
        //ph.cnclose();        
        c.GetDs("update Paypal set IsSeen='Yes' ");  
        Response.Redirect("PaypalOrder.aspx");
    }
    protected void btndelete_Click(object sender, EventArgs e)
    {
        c.GetDs("delete from Paypal where Id='" + TextBox1.Text + "'");      
        Response.Redirect("PaypalOrder.aspx");
    }
}