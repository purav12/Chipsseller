<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="SignUpFirst.aspx.cs" Inherits="SignUpFirst" %>
        ...
        <div id="container">
            ...
            <div id="contact" class="clear">
                ...
                <div class="one_half first">
                    <h1>Sign Up First</h1>
                    <p>
                        You Must Have To Sign Up First To See That Page
                    </p>
                    <p>
                                ...
                                <ContentTemplate>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <br />
                                                <asp:TextBox ID="txtSalary" Style="border: 1px solid #717171 !important;" runat="server" TextMode="Password"></asp:TextBox>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <br />
                                                <asp:TextBox ID="txtConfirmPassword" Style="border: 1px solid #717171 !important;" runat="server" TextMode="Password"></asp:TextBox>
