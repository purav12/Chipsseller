<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="Reports.aspx.cs" Inherits="Chart" %>
            ...
            <div class="clear push50">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtsql" runat="server" Text="SELECT *,Case when Amount='0' then '9' else CONVERT(FLOAT,Amount)/Cast(Stock as int) end  AS Rate FROM DailyDetails "
