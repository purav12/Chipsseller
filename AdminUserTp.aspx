<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdminUserTp.aspx.cs" Inherits="AdminUserTp" %>
                ...
                <table>
                    <tr>
                        ...
                        <td class="style2">
                            ...
                            <asp:TextBox ID="txtdesc" Style="margin-top: 10px; margin-bottom: 10px; width: 300px;" Visible="false" runat="server"></asp:TextBox>
                            ...
                            <asp:TextBox ID="txtcommentlast" Style="margin-top: 10px; margin-bottom: 10px; width: 200px;" Visible="false" runat="server"></asp:TextBox>
                        </td>
                        <td></td>
                    </tr>
                </table>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Chips">
                                                <ItemTemplate>
                                                    ...
                                                    &nbsp
                                                    <asp:Label ID="Label2" runat="server" Text='Lakhs'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            ...
                            <p>
                                <asp:GridView ID="grdtopbuyers" runat="server" CssClass="mGrid" GridLines="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TotalChips" HeaderText="Chips (Lakhs)" SortExpression="TotalChips" />
                            ...
                            <p>
                                <asp:GridView ID="grdtopsellers" runat="server" CssClass="mGrid" GridLines="None"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="Customer_Name" HeaderText="Customer Name" />
                                        <asp:BoundField DataField="Amount" HeaderText="Amount" />
                                        <asp:BoundField DataField="TotalChips" HeaderText="Chips (Lakhs)" />
                                        <asp:BoundField DataField="Rate" DataFormatString="{0:0.00}" HeaderText="Rate" />
                                    </Columns>
                                </asp:GridView>
                            </p>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td class="style2">
                            <asp:TextBox ID="txtsql" runat="server" Text="SELECT * FROM DailyDetails where CreateDate  BETWEEN '6/28/2013' and '7/28/2013' ORDER BY CreateDate"
